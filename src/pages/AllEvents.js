...
const AllEvents = () => {
    ...
    const eventEdit = async () => {
        try {
            ...
            appendIfValue("discount", discount);
                    ...
                    {modalType == "detail" ? <>
                        ...
                        <div className="modal-body">
                            <div className="input-group input-group-sm mb-3 w-100">
                                ...
                                <input type="text" maxLength={30} className="form-control" placeholder='Enter Title' aria-label="Title" value={title} onChange={(e) => setTitle(e.target.value)} />
                            </div>
                            <div className="input-group input-group-sm mb-3 w-100">
                                {/* <div className="input-group-prepend">
                            ...
                            {type == "paid" ?
                                <>
                                    <div className="input-group input-group-sm mb-3 w-100">
                                        ...
                                        <input min={1} maxLength={5} type="text" pattern="[0-9]*\.?[0-9]*" className="form-control" placeholder='Enter Price' aria-label="Price" value={price} onChange={(e) => {
                                    ...
                                    <div className="input-group input-group-sm mb-3 w-100">
                                        ...
                                        <input min={1} maxLength={3} type="text" pattern="[0-9]*\.?[0-9]*" className="form-control" placeholder='Enter Discount' aria-label="discount" defaultValue={detail?.discount} value={discount} onChange={(e) => {
                                            let value = e.target.value;
                                            value = value.replace(/[^0-9.]/g, '');
                                            if (value.startsWith('.')) {
                                                value = '0' + value;
                            ...
                            <div className="input-group input-group-sm mb-3 w-100">
                                {/* <div className="input-group-prepend">
                                    <span className="input-group-text" id="inputGroup-sizing-sm">Event Date</span>
                                </div> */}

                                <input type="date" placeholder='Enter Date' min={moment(new Date()).format("YYYY-MM-DD")} className="form-control" aria-label="Validity" value={valid} onChange={(e) => setValid(e.target.value)} />
                            </div>
                            <div className="input-group input-group-sm mb-3 w-100">
                                {/* <div className="input-group-prepend">
                            ...
                            <div className="input-group input-group-sm mb-3 w-100">
                                <input min={1} maxLength={10} type="text" pattern="[0-9]*\.?[0-9]*" className="form-control" placeholder='Enter M8s' aria-label="ParticipantLimit" value={participantLimit} onChange={(e) => {
                                    let value = e.target.value;
                                    value = value.replace(/[^0-9]/g, '');
                            ...
                            <div className="input-group input-group-sm mb-3 w-100">
                                <input type="text" className="form-control" aria-label="Category" placeholder='Enter Category' value={category} onChange={(e) => setCategory(e.target.value)} />
                            </div>
                            <div className="input-group input-group-sm mb-3 w-100">
                                <textarea maxLength="300" type="text" className="form-control" placeholder='Enter Description' aria-label="Description" value={description} onChange={(e) => setDescription(e.target.value)} />
                            </div>
                            <div className="input-group input-group-sm mb-3 w-100">
                        ...
                        <div className="modal-body">
                            <div className="input-group input-group-sm mb-3 w-100">
                                <input type="text" maxLength={30} className="form-control" placeholder='Enter Title' aria-label="Title" defaultValue={detail.title} value={title} onChange={(e) => setTitle(e.target.value)} />
                            </div>
                            <div className="input-group input-group-sm mb-3 w-100">
                            ...
                            {type == "paid" ?
                                <>
                                    <div className="input-group input-group-sm mb-3 w-100">
                                        <input min={1} maxLength={5} type="text" pattern="[0-9]*\.?[0-9]*" className="form-control" placeholder='Enter Price' aria-label="Price" defaultValue={detail.price} value={price} onChange={(e) => {
                                            let value = e.target.value;
                                            value = value.replace(/[^0-9.]/g, '');
                                            if (value.startsWith('.')) {
                                                value = '0' + value;
                            ...
                            <div className="input-group input-group-sm mb-3 w-100">
                                <div className="auto-complete">
                                    <GooglePlacesAutocomplete
                                        selectProps={{
                                            isClearable: true,
                                            placeholder: detail?.location?.address ? detail?.location?.address : 'Select Location',
                                            value,
                                            onChange: setValue,
                                            styles: {
                                                input: (provided) => ({
                            ...
                            <div className="input-group input-group-sm mb-3 w-100">
                                <input min={1} maxLength={10} type="text" pattern="[0-9]*\.?[0-9]*" className="form-control" placeholder='Enter #M8s' aria-label="#M8s" defaultValue={detail.participantLimit} value={participantLimit} onChange={(e) => {
                                    let value = e.target.value;
                                    value = value.replace(/[^0-9]/g, '');
                                    setParticipantLimit(value);
                                }} />
                            ...
                            <div className="input-group input-group-sm mb-3 w-100">
                                <input type="text" className="form-control" aria-label="Category" placeholder='Enter Category' defaultValue={detail.category} value={category} onChange={(e) => setCategory(e.target.value)} />
                            </div>
                            <div className="input-group input-group-sm mb-3 w-100">
                                <textarea maxLength="300" type="text" className="form-control" placeholder='Enter Description' aria-label="Description" defaultValue={detail.description} value={description} onChange={(e) => setDescription(e.target.value)} />
                            </div>
                            <div className="input-group input-group-sm mb-3 w-100">
                                <input type="file" className="form-control" aria-label="Image" onChange={(e) => setFiles(e?.target?.files[0])} />
                            </div>
                                                ...
                                                <tbody >
                                                    {eventList?.map((item, i) => (
                                                        <tr key={i}>
                                                            <td>{i + 1}</td>
                                                            <td>{item?.title}</td>
                                                            <td>{item?.type == "free" ? "Free" : item?.type == "paid" ? "Paid" : ""}</td>
                                                            <td>{moment(item?.valid).format("MM-DD-YYYY")}</td>
